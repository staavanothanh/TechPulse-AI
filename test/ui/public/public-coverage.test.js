...
describe('public coverage states', () => {
  ...
  it('covers Q&A history, message, citation and confirmation states', () => {
    ...
    expect(empty).toContain('Chọn ít nhất một chủ đề hoặc cung cấp đủ hai mốc thời gian trước khi hỏi.')
    ...
    expect(nullScope).toContain('Chọn ít nhất một chủ đề hoặc cung cấp đủ hai mốc thời gian trước khi hỏi.')
