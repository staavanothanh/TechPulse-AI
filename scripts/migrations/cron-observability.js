...
export const CRON_LIFECYCLE_EVENT_SCHEMA = Object.freeze({
  ...
  properties: {
    ...
    periodTimezone: { enum: ['UTC'] },
    materializationReason: { enum: ['materialized', 'already_materialized', 'no_eligible_sources', 'deferred', 'failed'] },
    outcome: { enum: ['completed', 'deferred', 'failed'] },
    alreadyMaterialized: { bsonType: 'bool' },
    completedAt: { bsonType: ['date', 'null'] },
    eligibleSourceCount: { bsonType: ['int', 'null'], minimum: 0 },
    invocationOrigin: { bsonType: 'string', minLength: 1, maxLength: 128 },
