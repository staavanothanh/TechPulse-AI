...
for (const name of ['RegisterRequest', 'LoginRequest', 'PreferencesRequest', 'AdminUserUpdateRequest', 'ChangePasswordRequest']) validators.set(name, ajv.compile({ $ref: `#/components/schemas/${name}` }))
